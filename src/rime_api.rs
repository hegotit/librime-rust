...
pub struct RimeApi {
    ...
    set_notification_handler: Option<
        extern "C" fn(handler: RimeNotificationHandler, context_object: *mut c_void),
    >,
    ...
    deploy_config_file: Option<
        extern "C" fn(file_name: *const c_char, version_key: *const c_char) -> Bool,
    >,
    ...
    process_key: Option<unsafe extern "C" fn(session_id: RimeSessionId, keycode: c_int, mask: c_int) -> Bool>,
    ...
    get_commit: Option<unsafe extern "C" fn(session_id: RimeSessionId, commit: *mut RimeCommit) -> Bool>,
    free_commit: Option<unsafe extern "C" fn(commit: *mut RimeCommit) -> Bool>,
    get_context: Option<unsafe extern "C" fn(session_id: RimeSessionId, context: *mut RimeContext) -> Bool>,
    free_context: Option<unsafe extern "C" fn(ctx: *mut RimeContext) -> Bool>,
    get_status: Option<unsafe extern "C" fn(session_id: RimeSessionId, status: *mut RimeStatus) -> Bool>,
    free_status: Option<unsafe extern "C" fn(status: *mut RimeStatus) -> Bool>,
    set_option: Option<unsafe extern "C" fn(session_id: RimeSessionId, option: *const c_char, value: Bool)>,
    get_option: Option<unsafe extern "C" fn(session_id: RimeSessionId, option: *const c_char) -> Bool>,
    set_property: Option<unsafe extern "C" fn(session_id: RimeSessionId, prop: *const c_char, value: *const c_char)>,
    get_property: Option<
        extern "C" fn(
            session_id: RimeSessionId,
            prop: *const c_char,
    ...
    get_current_schema: Option<
        extern "C" fn(session_id: RimeSessionId, schema_id: *mut c_char, buffer_size: usize) -> Bool,
    >,
    select_schema: Option<unsafe extern "C" fn(session_id: RimeSessionId, schema_id: *const c_char) -> Bool>,
    schema_open: Option<unsafe extern "C" fn(schema_id: *const c_char, config: *mut RimeConfig) -> Bool>,
    config_open: Option<unsafe extern "C" fn(config_id: *const c_char, config: *mut RimeConfig) -> Bool>,
    config_close: Option<unsafe extern "C" fn(config: *mut RimeConfig) -> Bool>,
    config_get_bool: Option<unsafe extern "C" fn(config: *mut RimeConfig, key: *const c_char, value: *mut Bool) -> Bool>,
    config_get_int: Option<unsafe extern "C" fn(config: *mut RimeConfig, key: *const c_char, value: *mut c_int) -> Bool>,
    config_get_double: Option<unsafe extern "C" fn(config: *mut RimeConfig, key: *const c_char, value: *mut f64) -> Bool>,
    ...
    >,
    config_get_cstring: Option<unsafe extern "C" fn(config: *mut RimeConfig, key: *const c_char) -> *const c_char>,
    config_update_signature: Option<unsafe extern "C" fn(config: *mut RimeConfig, signer: *const c_char) -> Bool>,
    config_begin_map: Option<unsafe extern "C" fn(iterator: *mut RimeConfigIterator, config: *mut RimeConfig, key: *const c_char) -> Bool>,
    ...
    // testing
    simulate_key_sequence: Option<unsafe extern "C" fn(session_id: RimeSessionId, key_sequence: *const c_char) -> Bool>,
    ...
    config_load_string: Option<unsafe extern "C" fn(config: *mut RimeConfig, yaml: *const c_char) -> Bool>,

    // configuration setters
    config_set_bool: Option<unsafe extern "C" fn(config: *mut RimeConfig, key: *const c_char, value: Bool) -> Bool>,
    config_set_int: Option<unsafe extern "C" fn(config: *mut RimeConfig, key: *const c_char, value: i32) -> Bool>,
    config_set_double: Option<unsafe extern "C" fn(config: *mut RimeConfig, key: *const c_char, value: f64) -> Bool>,
    config_set_string: Option<unsafe extern "C" fn(config: *mut RimeConfig, key: *const c_char, value: *const c_char) -> Bool>,

    // configuration manipulation
    config_get_item: Option<unsafe extern "C" fn(config: *mut RimeConfig, key: *const c_char, value: *mut RimeConfig) -> Bool>,
    config_set_item: Option<unsafe extern "C" fn(config: *mut RimeConfig, key: *const c_char, value: *mut RimeConfig) -> Bool>,
    config_clear: Option<unsafe extern "C" fn(config: *mut RimeConfig, key: *const c_char) -> Bool>,
    config_create_list: Option<unsafe extern "C" fn(config: *mut RimeConfig, key: *const c_char) -> Bool>,
    config_create_map: Option<unsafe extern "C" fn(config: *mut RimeConfig, key: *const c_char) -> Bool>,
    config_list_size: Option<unsafe extern "C" fn(config: *mut RimeConfig, key: *const c_char) -> usize>,
    config_begin_list: Option<unsafe extern "C" fn(iterator: *mut RimeConfigIterator, config: *mut RimeConfig, key: *const c_char) -> Bool>,
    ...
    select_candidate_on_current_page: Option<unsafe extern "C" fn(session_id: RimeSessionId, index: usize) -> Bool>,

    // candidate list access
    candidate_list_begin: Option<unsafe extern "C" fn(session_id: RimeSessionId, iterator: *mut RimeCandidateListIterator) -> Bool>,
    candidate_list_next: Option<unsafe extern "C" fn(iterator: *mut RimeCandidateListIterator) -> Bool>,
    candidate_list_end: Option<unsafe extern "C" fn(iterator: *mut RimeCandidateListIterator)>,

    user_config_open: Option<unsafe extern "C" fn(config_id: *const c_char, config: *mut RimeConfig) -> Bool>,
    candidate_list_from_index: Option<unsafe extern "C" fn(session_id: RimeSessionId, iterator: *mut RimeCandidateListIterator, index: i32) -> Bool>,

    // protobuf
    commit_proto: Option<unsafe extern "C" fn(session_id: RimeSessionId, commit_builder: *mut RimeProtoBuilder)>,
    context_proto: Option<unsafe extern "C" fn(session_id: RimeSessionId, context_builder: *mut RimeProtoBuilder)>,
    status_proto: Option<unsafe extern "C" fn(session_id: RimeSessionId, status_builder: *mut RimeProtoBuilder)>,

    get_state_label: Option<unsafe extern "C" fn(session_id: RimeSessionId, option_name: *const c_char, state: Bool) -> *const c_char>,
    delete_candidate: Option<unsafe extern "C" fn(session_id: RimeSessionId, index: usize) -> Bool>,
    delete_candidate_on_current_page: Option<unsafe extern "C" fn(session_id: RimeSessionId, index: usize) -> Bool>,

    get_state_label_abbreviated: Option<unsafe extern "C" fn(session_id: RimeSessionId, option_name: *const c_char, state: Bool, abbreviated: Bool) -> RimeStringSlice>,
    set_input: Option<unsafe extern "C" fn(session_id: RimeSessionId, input: *const c_char) -> Bool>,
    ...
    highlight_candidate: Option<unsafe extern "C" fn(session_id: RimeSessionId, index: usize) -> Bool>,
    highlight_candidate_on_current_page: Option<unsafe extern "C" fn(session_id: RimeSessionId, index: usize) -> Bool>,
